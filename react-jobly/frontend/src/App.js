...
class App extends Component {
  ...
  render() {
    let background = this.state.currentUser
      ? ""
      : "https://images.unsplash.com/photo-1502945015378-0e284ca1a5be?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80";
